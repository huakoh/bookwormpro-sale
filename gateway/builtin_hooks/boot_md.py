"""Built-in boot-md hook — run ~/.bookwormpro/BOOT.md on gateway startup.

This hook is always registered. It silently skips if no BOOT.md exists.
To activate, create ``~/.bookwormpro/BOOT.md`` with instructions for the
...
BOOT_FILE = BOOKWORMPRO_HOME / "BOOT.md"
