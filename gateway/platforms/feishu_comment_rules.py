...
Config: ~/.bookwormpro/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.bookwormpro/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (BOOKWORMPRO_HOME-aware and
