"""
Email platform adapter for the BookwormPRO gateway.

Allows users to interact with BookwormPRO by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "BookwormPRO")
        ...
        msg_id = f"<bookworm-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
