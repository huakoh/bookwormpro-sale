...
def _reload_constants():
    """Reload bwm_constants to get a fresh apply_ipv4_preference."""
    import bwm_constants
    importlib.reload(bwm_constants)
    return bwm_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_bwm_ipv4_patched", False) is True
