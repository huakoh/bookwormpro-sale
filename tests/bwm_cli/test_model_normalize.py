"""Tests for bwm_cli.model_normalize — provider-aware model name normalization.
...
class TestAggregatorProviders:
    ...
    def test_nous_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "bookwormpro")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (BookwormPRO portal, OpenRouter via DeepInfra) routes to V3 —
