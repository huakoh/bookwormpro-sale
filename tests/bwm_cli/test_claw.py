"""Tests for bookworm claw commands."""
...
from bwm_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.bookwormpro/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.bookwormpro/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.bookwormpro/migration/openclaw/20250312T120000",
        }
