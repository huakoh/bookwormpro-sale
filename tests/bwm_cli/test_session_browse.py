"""Tests for the interactive session browser (`bookworm sessions browse`).
...
from bwm_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """bookworm sessions browse should be parseable."""
        from bwm_cli.main import main as _main_entry
