...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_models_py(self):
        from bwm_cli.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
        from bwm_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from bwm_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from bwm_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_lowercase_model_provider(self):
        ...
        from bwm_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in BOOKWORMPRO_OVERLAYS
        overlay = BOOKWORMPRO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify bookworm doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from bwm_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from bwm_cli.providers import BOOKWORMPRO_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = BOOKWORMPRO_OVERLAYS["xiaomi"]
