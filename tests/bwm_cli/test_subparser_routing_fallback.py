...
The main() function in bwm_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `bookworm -c model`
...
def _build_parser():
    """Build a minimal replica of the bookworm top-level parser."""
