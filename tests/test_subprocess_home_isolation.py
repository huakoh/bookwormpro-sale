...
See: https://github.com/huakoh/BookwormPRO/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for bwm_constants.get_subprocess_home()."""
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        base = tmp_path / ".bookwormpro" / "profiles"
        ...
        monkeypatch.setenv("BOOKWORMPRO_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("BOOKWORMPRO_HOME", str(base / "beta"))
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from bwm_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from bwm_cli.profiles import create_profile
