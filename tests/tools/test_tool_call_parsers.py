...
# ─── BookwormPRO parser tests ────────────────────────────────────────────────

class TestHermesParser:
    @pytest.fixture
    def parser(self):
        return get_parser("bookworm")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["bookworm"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use bookworm format since that's universal
