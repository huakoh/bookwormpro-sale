...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because bookworm uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("BOOKWORMPRO_GATEWAY_SESSION", "1")
        monkeypatch.delenv("BOOKWORMPRO_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("BOOKWORMPRO_INTERACTIVE", raising=False)
        monkeypatch.delenv("BOOKWORMPRO_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("BOOKWORMPRO_EXEC_ASK", "1")
