...
Verifies that BookwormPRO-managed provider, tool, and gateway env vars are
stripped from subprocess environments so external CLIs are not silently
misrouted or handed BookwormPRO secrets.

See: https://github.com/huakoh/BookwormPRO/issues/1002
See: https://github.com/huakoh/BookwormPRO/issues/1264
"""
...
class TestProviderEnvBlocklist:
    """Provider env vars loaded from ~/.bookwormpro/.env must not leak."""
