#!/usr/bin/env python3
"""Build the BookwormPRO Skills Index — a centralized JSON catalog of all skills.
...
`bookworm skills search/install` can use it without hitting the GitHub API.
...
# Ensure BOOKWORMPRO_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("BOOKWORMPRO_HOME", os.path.join(os.path.expanduser("~"), ".bookwormpro"))
...
def main():
    print("Building BookwormPRO Skills Index...", flush=True)
