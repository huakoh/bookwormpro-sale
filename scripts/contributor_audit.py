...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^BookwormPRO\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "bookworm@bookwormpro.local",
    "bookworm-audit@example.com",
    "bookworm@habibilabs.dev",
}
