---
name: bookworm-atropos-environments
description: Build, test, and debug BookwormPRO RL environments for Atropos training. Covers the BookwormproAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the bookwormpro repo.
version: 1.1.0
author: BookwormPRO
license: MIT
metadata:
