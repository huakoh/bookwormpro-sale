"""BookwormPRO CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.bookwormpro/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "BookwormPRO"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! [BWM]"              # Shown on exit
      response_label: " [BWM] BookwormPRO "       # Response box header label
...
.. code-block:: python
    ...
    from bwm_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "BookwormPRO"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.bookwormpro/skins/
...
Drop a YAML file in ``~/.bookwormpro/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces BOOKWORMPRO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces BOOKWORMPRO_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "BookwormPRO 青蓝主题 — 与 Hero Logo VI 一致",
        "colors": {
            ...
            "session_label": "#48D1CC",
            "session_border": "#566573",
        },
        "spinner": {
            # Empty = use hardcoded defaults in display.py
        },
        "branding": {
            "agent_name": "BookwormPRO",
            "welcome": "",
            "goodbye": "再见",
            "response_label": " BookwormPRO ",
            "prompt_symbol": "❯ ",
            "help_header": "可用命令",
        },
        "tool_prefix": "┊",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "BookwormPRO",
            "welcome": "Welcome to BookwormPRO! Type your message or /help for commands.",
            "goodbye": "Goodbye! [BWM]",
            "response_label": " [BWM] BookwormPRO ",
            "prompt_symbol": "❯ ",
            "help_header": "[?] Available Commands",
        },
        "tool_prefix": "┊",
...
def get_active_goodbye(fallback: str = "Goodbye! [BWM]") -> str:
