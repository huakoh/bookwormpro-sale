"""
Skills configuration for BookwormPRO.
`bookworm skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.bookwormpro/config.yaml under:
...
def skills_command(args=None):
    """Entry point for `bookworm skills`."""
    from bwm_cli.curses_ui import curses_checklist
    ...
    if mode == "2":
        ...
        # "selected" = enabled (not disabled) — matches the [[成功]] convention
