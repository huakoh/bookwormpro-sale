"""
Dump command for bookworm CLI.

Outputs a compact, plain-text summary of the user's BookwormPRO setup
...
from bwm_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
        from bwm_cli.gateway import get_gateway_runtime_snapshot
...
def run_dump(args):
    ...
    lines.append(f"bookwormpro_home: {display_hermes_home()}")
    ...
    toolsets = config.get("toolsets", ["bookworm-cli"])
