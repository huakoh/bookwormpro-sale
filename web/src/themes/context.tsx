...
const STORAGE_KEY = "bookworm-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `bwm_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "bookworm-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-bookworm-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-bookworm-theme-font", "true");
