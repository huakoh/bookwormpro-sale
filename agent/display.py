...
def _detect_tool_failure(tool_name: str, result: str | None) -> tuple[bool, str]:
    ...
    # \u7ed3\u6784\u5316\u5de5\u5177\uff08\u8fd4\u56de JSON \u4e14\u542b\u660e\u786e success \u5b57\u6bb5\uff09\u6309 success \u5224\u5b9a\uff0c
    # \u4e0d\u76f2\u626b "error"/"failed" \u5b50\u4e32\u2014\u2014\u907f\u514d\u6280\u80fd\u5185\u5bb9\u542b\u8fd9\u7c7b\u8bcd\u65f6\u8bef\u62a5
    # \uff08\u5982 skill_view \u8fd4\u56de\u7684\u6280\u80fd\u6b63\u6587\u542b\u201c\u9519\u8bef\u5904\u7406/error handling\u201d\uff09\u3002
    _STRUCTURED_SUCCESS_TOOLS = {
        "skill_view", "skills_list", "skill_manage", "skill_manage_tool",
        "memory_search", "search_files", "read_file",
    }
    if tool_name in _STRUCTURED_SUCCESS_TOOLS:
        data = safe_json_loads(result)
        if isinstance(data, dict) and "success" in data:
            return (not data["success"]), (" [error]" if not data["success"] else "")
        # \u65e0 success \u5b57\u6bb5\uff08\u5982\u7eaf\u6587\u672c\u8fd4\u56de\uff09\u2014\u2014\u8be5\u7c7b\u5de5\u5177\u6b63\u5e38\u8fd4\u56de\u4e0d\u8be5\u6807 error\uff0c\u76f4\u63a5\u5f53\u6210\u529f\u3002
        return False, ""
