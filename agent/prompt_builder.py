...
MEMORY_GUIDANCE = (
    ...
    "Your memory has THREE TEMPORAL LAYERS: SHORT_TERM (0-24h, active session), "
    "MEDIUM_TERM (24h-7d, project context), LONG_TERM (7d+, permanent facts). "
    "Memories auto-promote through layers based on age and access frequency."
)
