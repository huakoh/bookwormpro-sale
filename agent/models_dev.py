...
Data resolution order (like TypeScript OpenCode):
  ...
  2. Disk cache (~/.bookwormpro/models_dev_cache.json)
...
# ---------------------------------------------------------------------------
# Provider ID mapping: BookwormPRO ↔ models.dev
# ---------------------------------------------------------------------------

# BookwormPRO provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → BookwormPRO (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a BookwormPRO provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal BookwormPRO agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a BookwormPRO provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve BookwormPRO ID → models.dev ID
...
def get_model_info(
    ...
    Accepts BookwormPRO or models.dev provider ID.  Tries exact match then
