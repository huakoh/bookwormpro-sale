#!/usr/bin/env python3
"""
SQLite State Store for BookwormPRO.
...
class SessionDB:
    ...
    # With multiple bookworm processes (gateway + CLI sessions + worktree agents)
    ...
    def get_messages_as_conversation(self, session_id: str) -> List[Dict[str, Any]]:
        ...
        for row in rows:
            ...
            # that replay reasoning (OpenRouter, OpenAI, BookwormPRO) receive
