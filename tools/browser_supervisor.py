...
One ``CDPSupervisor`` runs per BookwormPRO ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "bookworm-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://bookworm-dialog-bridge.invalid/";
