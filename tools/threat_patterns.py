...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|HERMES|BOOKWORMPRO|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.(hermes|bookwormpro)/\.env|\~/\.(hermes|bookwormpro)/\.env', "agent_home_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.(hermes|bookwormpro)/(config\.yaml|SOUL\.md)', "agent_config_mod2", "strict"),
