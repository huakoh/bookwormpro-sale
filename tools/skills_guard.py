...
Trust levels:
  - builtin:   Ships with BookwormPRO. Never scanned, always trusted.
...
class ScanResult:
    ...
    verdict: str        # "safe" | "notice" | "caution" | "dangerous"
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.bookwormpro/\.env|\~/\.bookwormpro/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references BookwormPRO secrets file"),
    ...
    (r'\.bookwormpro/config\.yaml|\.bookwormpro/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references BookwormPRO configuration files directly"),
