...
```python
import sys
sys.path.insert(0, "/home/teknium/.bookwormpro/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.bookwormpro/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — BookwormPRO installs package this)
