...
```bash
python3 -m pyfiglet "BOOKWORMPRO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=BOOKWORMPRO&font=Slant" | boxes -d stone
```
