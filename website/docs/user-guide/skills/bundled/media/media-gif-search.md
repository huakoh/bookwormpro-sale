...
Set your Tenor API key in your environment (add to `~/.bookwormpro/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/huakoh/BookwormPRO/blob/main/skills/media/gif-search/url)`
