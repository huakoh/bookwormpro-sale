...
| Version | `1.1.0` |
| Author | BookwormPRO (adapted from obra/superpowers) |
| License | MIT |
...
> **For BookwormPRO:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use BookwormPRO tools to understand the project:
