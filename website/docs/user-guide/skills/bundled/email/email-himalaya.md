...
To reply non-interactively from BookwormPRO, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from BookwormPRO)** — pipe the message via stdin:
