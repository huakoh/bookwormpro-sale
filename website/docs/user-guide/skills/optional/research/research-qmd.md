...
| | |
|---|---|
| Source | Optional — install with `bookworm skills install official/research/qmd` |
...
BookwormPRO via the native MCP client. This is the preferred
...
Then configure BookwormPRO to connect via HTTP:
