...
- User wants **BookwormPRO itself to drive a browser** → use BookwormPRO' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
