...
| | |
|---|---|
| Source | Optional — install with `bookworm skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/huakoh/BookwormPRO/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/huakoh/BookwormPRO/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
