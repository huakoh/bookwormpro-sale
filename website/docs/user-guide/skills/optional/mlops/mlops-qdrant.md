...
| | |
|---|---|
| Source | Optional — install with `bookworm skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/huakoh/BookwormPRO/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/huakoh/BookwormPRO/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
