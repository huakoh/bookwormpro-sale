...
| | |
|---|---|
| Source | Optional — install with `bookworm skills install official/health/neuroskill-bci` |
...
Connect BookwormPRO to a running [NeuroSkill](https://neuroskill.com/) instance to read
