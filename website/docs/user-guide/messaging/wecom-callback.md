...
Connect BookwormPRO to WeCom (Enterprise WeChat) as a self-built enterprise application using the callback/webhook model.

:::info WeCom Bot vs WeCom Callback
BookwormPRO supports two WeCom integration modes:
...
3. BookwormPRO decrypts the message, queues it for the agent
