...
| [**bookworm-atropos-environments**](/docs/user-guide/skills/optional/mlops/mlops-bookworm-atropos-environments) | Build, test, and debug BookwormPRO RL environments for Atropos training. Covers the HermesAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/eva... |
