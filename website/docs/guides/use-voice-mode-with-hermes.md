---
sidebar_position: 8
title: "Use Voice Mode with BookwormPRO"
description: "A practical guide to setting up and using BookwormPRO voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with BookwormPRO
...
- you want BookwormPRO sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in BookwormPRO.
...
## Step 1: make sure normal BookwormPRO works first
...
BookwormPRO supports both local and cloud speech stacks.
...
4. BookwormPRO transcribes and responds
...
- asking BookwormPRO to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full BookwormPRO loop.

## Tuning CLI behavior

### Silence threshold

If BookwormPRO starts/stops too aggressively, tune:
...
BookwormPRO stays a normal chat bot, but can speak replies.
...
- you want BookwormPRO to function like a portable research or ops assistant
...
BookwormPRO joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- BookwormPRO detects speech boundaries
- transcripts are posted in the associated text channel
- BookwormPRO responds in text and audio
...
1. get text BookwormPRO working
2. install `bookwormpro[voice]`
