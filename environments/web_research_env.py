...
Inspired by: GroceryMind — production BookwormPRO agent doing live web research
             across German grocery stores (firecrawl + bookwormpro)
"""
...
# Ensure bookwormpro root is on path
