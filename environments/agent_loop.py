...
Runs the bookwormpro tool-calling loop using standard OpenAI-spec tool calling.
...
identical to bookwormpro's run_agent.py. Tool execution is dispatched via
...
class HermesAgentLoop:
    """
    Runs bookwormpro's tool-calling loop using standard OpenAI-spec tool calling.
    ...
    async def run(self, messages: List[Dict[str, Any]]) -> AgentResult:
        ...
        for turn in range(self.max_turns):
            ...
            # bookwormpro's standalone parsers. This handles the case where
            ...
            if (
                ...
                try:
                    ...
                    fallback_parser = get_parser("bookworm")
            ...
            if assistant_msg.tool_calls:
                ...
                # Execute each tool call via bookwormpro's dispatch
