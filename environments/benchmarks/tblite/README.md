...
- **Dataset (ours):** [BookwormPRO/openthoughts-tblite](https://huggingface.co/datasets/BookwormPRO/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `BookwormPRO/terminal-bench-2`  | `BookwormPRO/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
