...
ALL bookwormpro tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all bookwormpro tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any bookwormpro tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("BOOKWORMPRO_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("BOOKWORMPRO_QUIET", None)
            else:
                os.environ["BOOKWORMPRO_QUIET"] = _prev_quiet
