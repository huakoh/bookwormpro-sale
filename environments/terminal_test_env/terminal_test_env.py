...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from BookwormPRO"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from BookwormPRO",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from BookwormPRO",
    },
    {
...
class TerminalTestEnv(HermesAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/bookwormpro/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="BookwormPRO/q-30b-t-h45-e1",
