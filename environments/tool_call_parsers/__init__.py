...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "bookworm", "mistral", "llama3_json")
...
from environments.tool_call_parsers.bookwormpro_parser import HermesToolCallParser  # noqa: E402, F401
