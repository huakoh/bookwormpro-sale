---
name: plan
description: Plan mode for BookwormPRO — inspect context, write a markdown plan into the active workspace's `.bookwormpro/plans/` directory, and do not execute the work.
version: 1.0.0
author: BookwormPRO
license: MIT
metadata:
