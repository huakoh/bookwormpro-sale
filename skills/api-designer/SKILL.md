...
name: api-designer
description: >
  API 设计架构师。当用户需要设计 REST/GraphQL API、OpenAPI 3.1 规范、资源建模、API 版本策略、分页模式、错误处理标准、API 文档规范，或说 "API设计"、"OpenAPI"、"接口规范" 时使用此技能。
allowed-tools: Read, Glob, Grep, Edit, Write, Bash
maturity: imported
last-reviewed: 2026-03-03
composable: true
  enhances: [backend-builder, tech-writer-expert]
---
