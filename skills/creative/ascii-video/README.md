...
Built for [BookwormPRO](https://github.com/huakoh/BookwormPRO). Usable in any coding agent. Canonical source lives here; synced to [`huakoh/BookwormPRO/skills/creative/ascii-video`](https://github.com/huakoh/BookwormPRO/tree/main/skills/creative/ascii-video) via PR.
