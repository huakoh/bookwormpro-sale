"""ACP permission bridging — maps ACP approval requests to bookworm approval callbacks."""
...
# Maps ACP PermissionOptionKind -> bookworm approval result strings
_KIND_TO_HERMES = {
    "allow_once": "once",
    "allow_always": "always",
    "reject_once": "deny",
...
def make_approval_callback(
    ...
    """
    Return a bookworm-compatible ``approval_callback(command, description) -> str``
